 ...
 */
public class GdProcessorStatus extends CsvFileProcessorAbs {
    ...
    public void process() {
        ...
        try {
            for (CSVRecord record : parser) {
                ...
                System.out.println("request : idPgad : " + idPgad + " operatorId : " + StubUtils.GD_ID);
                request = StubUtils.statusRequest(idPgad, StubUtils.GD_ID, prefix + new Date().getTime());
