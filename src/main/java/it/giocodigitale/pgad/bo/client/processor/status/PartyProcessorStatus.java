 ...
 */
public class PartyProcessorStatus extends CsvFileProcessorAbs {
    ...
    public void process() {
        ...
        System.out.println(" starting PartyProcessorStatus");
        ...
        try {
            for (CSVRecord record : parser) {
                ...
                System.out.println("request : idPgad : " + idPgad + " operatorId : " + StubUtils.PARTY_ID);
                request = StubUtils.statusRequest(idPgad, StubUtils.PARTY_ID, prefix + new Date().getTime());
