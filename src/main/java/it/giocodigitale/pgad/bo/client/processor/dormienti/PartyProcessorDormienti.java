 ...
 */
public class PartyProcessorDormienti extends CsvFileProcessorAbs {
        ...
        try {
            for (CSVRecord record : parser) {
                ...
                if (status.equalsIgnoreCase("1") || status.equalsIgnoreCase("2")|| status.equalsIgnoreCase("3")) {
                    ...
                    request = StubUtils.dormientiRequest(idPgad, StubUtils.PARTY_ID, prefix + new Date().getTime() , dateLastLogin, Integer.parseInt(cashAmount));
                    ...
                    System.out.println("--------------------------------------");
                    System.out.println("report as problematic user   " + idPgad + " : " + status);
                    System.out.println("--------------------------------------");
