...
public class ListaDormienti {

    private String gwHost ;

    public ListaDormienti(String gwHost){
        this.gwHost = gwHost;
    }
    ...
    public  JSONObject pgadRequestExe(JSONObject request){
        ...
        HttpPost httpPost = new HttpPost(gwHost + StubUtils.listaDormientiUri);
        ...
        try {
            ...
            if (entity != null) {
                ...
                JSONObject  obj1 = (JSONObject)  parser.parse(responseElements);
